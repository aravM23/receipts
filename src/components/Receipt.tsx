...
export const RECEIPT_WIDTH = 339;
    ...
    >
      ...
      <div>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 5 }}>
          ...
          <img src="/stanley-mark.png" alt="" style={{ display: "block", width: 23.188, height: 22.808 }} />
          <span
            className="font-sans"
        ...
        <div className="font-sans" style={{ textAlign: "center", fontSize: 14, fontWeight: 400, color: "#000", marginTop: 6 }}>
      ...
      <div>
        ...
        <div style={{ marginTop: 18, display: "flex", flexDirection: "column", gap: 14, textAlign: "center" }}>
      ...
      {/* ── Creator archetype ─────────────────────────────────── */}
      <div style={{ position: "relative", width: 315, marginLeft: -12, marginRight: -12 }}>
        <div
          style={{
            background: BOX,
            borderRadius: 18,
        ...
        >
          ...
          <div
            ...
            style={{ color: "#000", fontSize: 42, fontStyle: "italic", fontWeight: 500, lineHeight: 1, letterSpacing: "-1.05px" }}
          >
            {card.creator_type}
          </div>
        </div>
      ...
      <div>
        ...
        <div style={{ display: "flex", justifyContent: "center", marginTop: 10 }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src="/cocktail.png" alt="" width={158} style={{ display: "block", height: "auto" }} />
        </div>
      ...
      <div>
        <div style={{ display: "flex", justifyContent: "center" }}>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={qrDataUrl} alt="Scan for your card" width={128} height={128} style={{ width: 128, height: 128, display: "block" }} />
        </div>
        <div
          className="font-sans"
          style={{ textAlign: "center", fontSize: 14, fontWeight: 400, lineHeight: 1.4, letterSpacing: "-0.35px", color: "#000", marginTop: 18 }}
        >
...
function VerifiedBadge() {
  return (
    <svg width="22.802" height="22.802" viewBox="0 0 24 24" fill="#3a8df0" aria-hidden style={{ display: "block" }}>
...
function DollarBadge() {
  return (
    // eslint-disable-next-line @next/next/no-img-element
    <img src="/icon-dollar.png" alt="" width={32} height={32} style={{ display: "block", flex: "0 0 auto" }} />
  );
}
